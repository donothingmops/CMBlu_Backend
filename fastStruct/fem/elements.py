...
from fastStruct.basic import FEMException

if TYPE_CHECKING:
    from fastStruct.fem.node import Node
    from fastStruct.fem.system import Spring
    from fastStruct.types import ElementType
    from fastStruct.vertex import Vertex

try:
    from fastStruct.fem.cython.celements import (  # pylint: disable=unused-import
        det_axial,
        det_moment,
        det_shear,
    )
except ImportError:
    from fastStruct.fem.cython.elements import det_axial, det_moment, det_shear
