...
from fastStruct.basic import arg_to_list
...
class LoadCombination:
    ...
    def add_load_case(
        ...
        :param lc: (:class:`fastStruct.fem.util.LoadCase`)
    ...
    def solve(
        ...
        **kwargs: Any,
        ...
        :param system: (:class:`fastStruct.fem.system.SystemElements`) Structure to apply loads on.
